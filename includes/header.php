    ...
    <div class="container-fluid justify-content-center w-auto">
        ...
        <div class="collapse navbar-collapse" id="studentNavbar">
            <ul class="navbar-nav align-items-lg-center">
                ...
                <?php } else { ?>
                    <li class="nav-item mx-1">
                        <a class="nav-link text-primary fw-medium px-3 py-2 rounded hover-bg" href="index.php">Home</a>
                    </li>
                    <li class="nav-item mx-1">
                        <a class="nav-link text-primary fw-medium px-3 py-2 rounded hover-bg" href="index.php#ulogin">User Login</a>
                    </li>
                    <li class="nav-item mx-1">
                        <a class="nav-link text-primary fw-medium px-3 py-2 rounded hover-bg" href="signup.php">User Signup</a>
                    </li>
                    <li class="nav-item mx-1">
                        <a class="nav-link text-primary fw-medium px-3 py-2 rounded hover-bg" href="adminlogin.php">Admin Login</a>
                    </li>
                <?php } ?>
            </ul>
        </div>
